...
// Handlers explícitos para os 5 CTAs do modal emergencial
const handleDayWhatsApp = () => {
  trackWhatsAppClick({ cta_location: 'emergency_modal', channel_type: 'emergency' })
}

const handlePhone39910280 = () => {
  trackPhoneClick({ cta_location: 'emergency_modal', phone_type: 'fixed_secondary' })
}

const handlePhone39910279 = () => {
  trackPhoneClick({ cta_location: 'emergency_modal', phone_type: 'fixed_primary' })
}

const handlePlantaoPhone = () => {
  trackPhoneClick({ cta_location: 'emergency_modal', phone_type: 'emergency' })
}

const handlePlantaoWhatsApp = () => {
  trackWhatsAppClick({ cta_location: 'emergency_modal', channel_type: 'emergency' })
}
</script>
        ...
        <div class="mb-4">
          <div class="flex items-center justify-between mb-2">
            ...
            <span v-if="isDayShift" class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-bold bg-emerald-100 text-emerald-800 border border-emerald-300">
              <span class="w-1.5 h-1.5 mr-1 bg-emerald-500 rounded-full animate-pulse" />
              Ativo agora
            </span>
          </div>
          ...
          <div class="space-y-2">
            ...
            <!-- 2. Landline 3991-0280 -->
            <a
              href="tel:1139910280"
              class="flex items-center justify-between p-3 bg-red-50 hover:bg-red-100 text-[#b91c1c] font-bold rounded-xl transition-all border border-red-200 min-h-[44px]"
              @click="handlePhone39910280"
            >
              <div class="flex items-center space-x-3">
            ...
            <!-- 3. Landline 3991-0279 -->
            <a
              href="tel:1139910279"
              class="flex items-center justify-between p-3 bg-red-50 hover:bg-red-100 text-[#b91c1c] font-bold rounded-xl transition-all border border-red-200 min-h-[44px]"
              @click="handlePhone39910279"
            >
              <div class="flex items-center space-x-3">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
          ...
          <div class="p-3.5 bg-gradient-to-r from-red-600 to-red-700 text-white font-bold rounded-xl shadow-md flex items-center justify-between flex-wrap gap-2" :class="{ 'ring-2 ring-red-500 ring-offset-1': !isDayShift }">
            ...
            <div class="flex items-center space-x-1.5 ml-auto sm:ml-0">
              ...
              <a
                ...
                @click="handlePlantaoPhone"
              >
                Ligar
              </a>
              <!-- 5. Plantão WhatsApp Link -->
              <a
