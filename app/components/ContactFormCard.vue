<template>
  <div class="bg-blue-50/70 border border-blue-100/90 rounded-2xl p-5 sm:p-8 shadow-sm">
    <div class="flex items-center space-x-3 mb-5 sm:mb-6 text-[#09357a]">
      ...
      <h2 class="text-lg sm:text-xl lg:text-2xl font-bold leading-tight">Solicite um Orçamento via WhatsApp</h2>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4 sm:space-y-5">
      ...
      <button
        type="submit"
        class="w-full flex items-center justify-center space-x-2 px-6 py-4 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold uppercase tracking-wider rounded-xl transition-all shadow-md active:scale-95 min-h-[52px]"
      >
